				    ...
				    html +='<div class="min-carousel-wrap">';
						...
						html += '<div class="">';
							html +='<h4>'+ val.restaurant_name +'</h4>';
  							if ((typeof val.distance_plot !== "undefined") && (val.distance_plot !== null)) {
						    ...
						    if( !empty(val.offers)){
						       ...
						       $.each( val.offers  , function( key_offer, val_offer ) {
						    		...
						    		if(empty(val_offer.icon)){
										...
										html+='<div class="rest-info promo delivery">';
						    				html+='<div>';
					    						html+='<img src="lib/icons/delivery-pink.svg" onerror="this.src=\'delivery-pink.png\'">';
						    					html+='<p class="concat_text">'+val_offer.raw+'</p>';	    	           	   
						    				html+='</div>';
						    			html+='</div>';
					    			}
...
fillCategories = function(data, div){
	...
	if(data_count>0){
			$.each(data, function(key, val){
				...
				html +='<div class="inner" onclick="showRestaurantListByTag('+ params_data +')">';
					html +='<div>';
				    	html +='<ons-ripple modifier="material"></ons-ripple>';
					    html +='<div class="banner">';		
